...
$categories = $categorieObj->recupererCategories();
?>
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-grow p-6">
            <header class="flex justify-between items-center mb-8">
                <h2 class="text-3xl font-bold text-blue-700">Manage Categories</h2>
                <button class="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800" onclick="window.location.href='/pages/admin-ajouter-categorie.php'">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 flex space-x-4">
                                <a href="/pages/admin-modifier-categorie.php?id=<?= $categorie['id'] ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Modifier</a>
                                <a href="/pages/admin-supprimer-categorie.php?id=<?= $categorie['id'] ?>" class="font-medium text-red-600 dark:text-red-500 hover:underline">Supprimer</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
